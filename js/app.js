...
function create() {
  ...
  var style = { font: "bold 32px Arial", fill: "#fff", boundsAlignH: "center", boundsAlignV: "middle" };
    ...
    scorelabel = game.add.text(-100, 0, "Your score is: ", style);
    scoretext = game.add.text(100, 0, score, style);
    scorelabel.setShadow(3, 3, 'rgba(0,0,0,0.5)', 2);
    scoretext.setShadow(3, 3, 'rgba(0,0,0,0.5)', 2);
    //  We'll set the bounds to be from x0, y450 (top down) and be 800px wide by 100px high
    scorelabel.setTextBounds(0, 450, 800, 100);
    scoretext.setTextBounds(0, 450, 800, 100);
